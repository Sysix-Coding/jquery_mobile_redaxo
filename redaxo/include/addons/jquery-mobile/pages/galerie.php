...
$dateien = array('galerie-eingabe.txt', 'galerie-ausgabe.txt');
$contents = array();
...
<div class="rex-addon-output">
	<h2 class="rex-hl2">Jquery-Mobile -  Modul "Galerie" - Eingabe</h2>
...
<div class="rex-addon-output">
	<h2 class="rex-hl2">Jquery-Mobile -  Modul "Galerie" - Ausgabe</h2>	
	<div class="rex-addon-content">	
