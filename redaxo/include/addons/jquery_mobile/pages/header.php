...
$dateien = array('header-eingabe.txt', 'header-ausgabe.txt');
$contents = array();
...
<div class="rex-addon-output">
	<h2 class="rex-hl2">Jquery-Mobile -  Modul "Header" - Eingabe</h2>
...
<div class="rex-addon-output">
	<h2 class="rex-hl2">Jquery-Mobile -  Modul "Header" - Ausgabe</h2>	
	<div class="rex-addon-content">	
